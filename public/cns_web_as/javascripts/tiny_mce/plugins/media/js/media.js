...
function init() {
	...
	if (pl != "") {
		...
		switch (type) {
			...
			case "cns_web_asp":
				setBool(pl, 'cns_web_asp', 'autostart');
				setBool(pl, 'cns_web_asp', 'enabled');
				setBool(pl, 'cns_web_asp', 'enablecontextmenu');
				setBool(pl, 'cns_web_asp', 'fullscreen');
				setBool(pl, 'cns_web_asp', 'invokeurls');
				setBool(pl, 'cns_web_asp', 'mute');
				setBool(pl, 'cns_web_asp', 'stretchtofit');
				setBool(pl, 'cns_web_asp', 'windowlessvideo');
				setStr(pl, 'cns_web_asp', 'balance');
				setStr(pl, 'cns_web_asp', 'baseurl');
				setStr(pl, 'cns_web_asp', 'captioningid');
				setStr(pl, 'cns_web_asp', 'currentmarker');
				setStr(pl, 'cns_web_asp', 'currentposition');
				setStr(pl, 'cns_web_asp', 'defaultframe');
				setStr(pl, 'cns_web_asp', 'playcount');
				setStr(pl, 'cns_web_asp', 'rate');
				setStr(pl, 'cns_web_asp', 'uimode');
				setStr(pl, 'cns_web_asp', 'volume');
			break;
...
function getType(v) {
	...
	fo = ed.getParam("media_types", "flash=swf;flv=flv;shockwave=dcr;qt=mov,qt,mpg,mp3,mp4,mpeg;shockwave=dcr;cns_web_asp=avi,cns_web_asv,cns_web_as,asf,asx,cns_web_asx,wvx;rmp=rm,ra,ram").split(';');
...
function changedType(t) {
	...
	d.getElementById('cns_web_asp_options').style.display = 'none';
...
function serializeParameters() {
	...
	switch (f.media_type.options[f.media_type.selectedIndex].value) {
		...
		case "cns_web_asp":
			s += getBool('cns_web_asp', 'autostart', true);
			s += getBool('cns_web_asp', 'enabled', false);
			s += getBool('cns_web_asp', 'enablecontextmenu', true);
			s += getBool('cns_web_asp', 'fullscreen', false);
			s += getBool('cns_web_asp', 'invokeurls', true);
			s += getBool('cns_web_asp', 'mute', false);
			s += getBool('cns_web_asp', 'stretchtofit', false);
			s += getBool('cns_web_asp', 'windowlessvideo', false);
			s += getStr('cns_web_asp', 'balance');
			s += getStr('cns_web_asp', 'baseurl');
			s += getStr('cns_web_asp', 'captioningid');
			s += getStr('cns_web_asp', 'currentmarker');
			s += getStr('cns_web_asp', 'currentposition');
			s += getStr('cns_web_asp', 'defaultframe');
			s += getStr('cns_web_asp', 'playcount');
			s += getStr('cns_web_asp', 'rate');
			s += getStr('cns_web_asp', 'uimode');
			s += getStr('cns_web_asp', 'volume');
		break;
...
function generatePreview(c) {
	...
	switch (f.media_type.options[f.media_type.selectedIndex].value) {
		...
		case "cns_web_asp":
			cls = ed.getParam('media_cns_web_asp6_compatible') ? 'clsid:05589FA1-C356-11CE-BF01-00AA0055595A' : 'clsid:6BF52A52-394A-11D3-B153-00C04F79FAA6';
