...
(function() {
	...
	tinymce.create('tinymce.plugins.MediaPlugin', {
					...
					each(dom.select('IMG', o.node), function(n) {
						...
						switch (n.className) {
							...
							case 'mceItemWindowsMedia':
								ci = ed.getParam('media_cns_web_asp6_compatible') ? '05589fa1-c356-11ce-bf01-00aa0055595a' : '6bf52a52-394a-11d3-b153-00c04f79faa6';
		...
		_createImg : function(cl, n) {
			...
			args = ['id', 'name', 'width', 'height', 'bgcolor', 'align', 'flashvars', 'src', 'cns_web_asode', 'allowfullscreen', 'quality'];	
